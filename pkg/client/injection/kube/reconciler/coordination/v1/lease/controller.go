...
import (
	...
	client "github.com/tektoncd/operator/pkg/client/injection/kube/client"
	lease "github.com/tektoncd/operator/pkg/client/injection/kube/informers/coordination/v1/lease"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "lease-controller"
	defaultFinalizerName       = "leases.coordination.k8s.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "coordination.k8s.io.Lease"),
	)
